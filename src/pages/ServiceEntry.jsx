    ...
    <div className="p-6 lg:p-8 space-y-6 select-none">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200/70 shadow-sm rounded-xl p-5 space-y-4">
            <h3 className="text-[10px] font-bold tracking-wider text-slate-400 uppercase border-b border-slate-100 pb-2">General Information</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <input type="text" defaultValue="11/24/2023" className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-2.5 text-xs font-semibold text-slate-700 outline-none" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <input type="text" placeholder="000,000" className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-2.5 text-xs font-semibold text-slate-700 outline-none pr-12" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-2.5 text-xs font-semibold text-slate-700 outline-none cursor-pointer">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  ...
                  <input type="text" defaultValue="0.00" className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-2.5 pl-7 text-xs font-semibold text-slate-700 outline-none" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/70 shadow-sm rounded-xl p-5 space-y-5">
            <h3 className="text-[10px] font-bold tracking-wider text-slate-400 uppercase border-b border-slate-100 pb-2">Service Details</h3>
            
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-wider text-slate-500 block">Work Performed / Complaints</label>
              <textarea placeholder="Describe the specific work performed or initial complaints reported by the driver..." rows="3" className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-3 text-xs font-semibold text-slate-700 outline-none resize-none"></textarea>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                {commonItems.map((item, index) => (
                  <label key={index} className="flex items-center space-x-3 border border-slate-100 p-2.5 rounded-lg hover:bg-slate-50 cursor-pointer transition">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white border border-slate-200/70 shadow-sm rounded-xl p-5 space-y-4">
            <h3 className="text-[10px] font-bold tracking-wider text-slate-400 uppercase border-b border-slate-100 pb-2">Documentation</h3>
            <div className="border border-dashed border-slate-300 rounded-xl p-6 text-center bg-slate-50/30 flex flex-col items-center justify-center cursor-pointer hover:bg-slate-50 transition">
            ...
            <div className="bg-slate-50 border border-slate-200 p-2.5 rounded-lg flex items-center justify-between text-[11px] font-bold text-slate-600">
