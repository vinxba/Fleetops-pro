...
export default function LoginPage({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 antialiased selection:bg-blue-100 selection:text-blue-900">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-10 transform transition-all duration-700 hover:scale-105">
          ...
          <h1 className="text-4xl font-black text-[#082f49] tracking-tighter">
        ...
        <div className="bg-white border border-slate-200/70 rounded-[3rem] p-10 shadow-[0_20px_50px_rgba(8,47,73,0.08)] relative overflow-hidden group">
          {/* Interactive header accent */}
          <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-blue-600 via-cyan-400 to-blue-600 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-1000 ease-in-out"></div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative group/field">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-700 outline-none focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 focus:bg-white transition-all duration-300 placeholder:text-slate-300 placeholder:font-medium tracking-tight"
                  required
                />
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative group/field">
                <input
                  ...
                  placeholder="••••••••••••"
                  className="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-12 pr-12 py-4 text-sm font-bold text-slate-700 outline-none focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 focus:bg-white transition-all duration-300 placeholder:text-slate-300 placeholder:font-medium tracking-tight"
                  required
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#0f2d4a] hover:bg-[#082f49] text-white font-black py-4.5 rounded-2xl shadow-xl shadow-blue-900/10 transition-all duration-300 transform hover:-translate-y-1 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {isLoading ? (
